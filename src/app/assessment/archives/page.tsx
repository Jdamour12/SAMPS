    ...
    <div className="space-y-6">
      <Card className="academic-card">
        <CardHeader>
          ...
          <CardDescription>Access historical assessment data and materials</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-t">
                    ...
                    <td className="p-3"><div className="flex gap-2"><Button size="sm" variant="outline">View</Button><Button size="sm" variant="outline">Download</Button></div></td>
                  </tr>
                  <tr className="border-t">
...
export default function AssessmentArchivesPage() {
  return (
    <PortalShell title="Assessment Archives" description="Access archived assessments and historical data.">
